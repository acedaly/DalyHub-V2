...
| [`development/AREAS_MODULE.md`](development/AREAS_MODULE.md) | The Areas module (AREA-01 done): data ownership (spine mutations + read-only `AreaRepository` projection), routes, Areas collection, New Area Drawer, canonical Area record, derived momentum semantics, Goal/Project presentation, Activity tab reuse, Project creation dependency, accessibility/responsive coverage, tests and deferrals to AREA-02/03/04. |
