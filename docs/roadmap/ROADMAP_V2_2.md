...
| **DS-04** | Tasks: `TaskRow` onto `compact`, list and table density, the bulk bar, inline edit. **Next.** The frame is now compact and quiet; the densest surface inside it is not | DS-02, DS-03 | Medium–high — the most-used surface, and D18/D32 are load-bearing |
