...
- **Non-goals:** Notes, Diary and Meetings (UIX-04's scope, and not on `main` —
  see the record's §0); any change to a domain rule, a repository, a schema or a
  write path; and any figure Analytics cannot produce exactly.
- Record:
