...
| [DEBT-243](../product/PRODUCT_DEBT.md#-debt-243--seven-surfaces-link-a-task-with-taskstask-a-parameter-nothing-reads--p3--closed-2026-09-08-v216-consol-03) — seven surfaces link a Task with a parameter nothing reads | P3 | **Not taken, and V2.10 must not become the eighth caller.** Life Admin's Task references use the drawer contract the Task drawer actually reads |
