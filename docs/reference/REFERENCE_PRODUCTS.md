...
| **Tiptap / ProseMirror** | Rich Markdown editor | `ueberdosis/tiptap`, `ProseMirror/*` | 🟢 MIT | **Not adopted.** [NOTES-01B](../roadmap/ROADMAP_V2.md#-notes-01b--notes-collection-and-canonical-markdown-record) shipped the Notes editor as DS-06's plain `MarkdownField` source textarea; [NOTES-01C](../roadmap/ROADMAP_V2.md#-notes-01c--notes-autosave-lifecycle--editor-polish) added a desktop Source/Split/Preview layout and dependable autosave WITHOUT rich-text authoring — the source textarea stays the one canonical editor. Revisit only if a later Notes item genuinely needs rich authoring while still saving Markdown source. |
...
- **Rich-text editors — Tiptap / ProseMirror / CodeMirror / Lexical / Milkdown / Monaco (mostly 🟢 MIT).** Authoring tools, not a render/storage foundation; they add large runtime weight. **Rejected for FND-08** — the Notes Markdown editor ([NOTES-01B](../roadmap/ROADMAP_V2.md#-notes-01b--notes-collection-and-canonical-markdown-record)) still saves Markdown source through the DS-06 `MarkdownField` control, never a rich-text editor's proprietary document model.
