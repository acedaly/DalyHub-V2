...
Eleven changes. Nine are one-line-to-one-block CSS corrections; two touch
components. **Every one of them is a repair to something the repository already
decided** — none introduces a new visual decision, and that is deliberate
(§17).
...
| **Product mean** | **7.9** | **7.4** | **8.2** | **8.0** | **8.0** | **7.8** | **8.9** | **7.8** | **8.0** | **8.3** | **8.1** |
...
**The eleven pre-existing failures**, named so a future run can tell them apart
