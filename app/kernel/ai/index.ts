...
export {
  ...
  type FactBlock,
  type FactBlockDraft,
  type FactBlockIntent,
  type FactBound,
  type FactBoundCode,
  type FactDraft,
  type FactPeriod,
  type FactReference,
  type FactReferenceKind,
  type FactValue,
  type FactValueKind,
  type NumericGroundingResult,
} from "./fact-block";
...
export {
  ...
  type FinanceCategorisationResult,
  type GroundedExplanationResult,
  type GroundedObservation,
  type JsonSchema,
  type MeetingExtractionResult,
  type ObligationFollowUpResult,
  type ObservedPattern,
  type ProposedFollowUpTask,
  type ProposedNote,
  type ProposedNotePurpose,
  type ProposedTask,
  type ProposedTransactionCategory,
  type ReviewReflectionDraftResult,
  type SuggestedLink,
...
export {
  ...
  type ProposalKind,
  type ProposalKindDescriptor,
  type ProposalTargetKind,
  type ProposalUndoStrategy,
} from "./proposal-kinds";
