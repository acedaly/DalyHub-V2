...
export const STRUCTURAL_TOKEN_NAMES = {
  ...
  sizing: [
    ...
    "app-entity-icon-size",
    "app-entity-icon-container-size",
    "app-chart-height-compact",
    "app-chart-height-standard",
    "app-progress-bar-height",
    "app-fab-band",
