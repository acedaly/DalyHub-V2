    ...
    const error = captureError(() =>
      createModuleRegistry([
        defineModule({
          ...
          name: "Notes",
          routes: [
            { id: "notes.x", path: "x", lazy: () => Promise.resolve({}) },
            { id: "notes.x", path: "y", lazy: () => Promise.resolve({}) },
          ],
        }),
      ]),
    );
    ...
    const error = captureError(() =>
      createModuleRegistry([
        defineModule({
          ...
          name: "Notes",
          routes: [
            { id: "notes.a", path: "shared", lazy: () => Promise.resolve({}) },
            { id: "notes.b", path: "shared", lazy: () => Promise.resolve({}) },
          ],
        }),
      ]),
    );
    ...
    expect(() =>
      createModuleRegistry([
        defineModule({
          ...
          name: "Notes",
          routes: [
            { id: "notes.p1", path: "p1", lazy: () => Promise.resolve({}) },
            { id: "notes.p2", path: "p2", lazy: () => Promise.resolve({}) },
            {
              id: "notes.c1",
              path: "child",
              parentId: "notes.p1",
    ...
    const error = captureError(() =>
      createModuleRegistry([
        defineModule({
          ...
          name: "Notes",
          routes: [
            { id: "notes.i1", index: true, lazy: () => Promise.resolve({}) },
            { id: "notes.i2", index: true, lazy: () => Promise.resolve({}) },
          ],
        }),
      ]),
    );
