...
**Also shipped since this section was last written.** The items previously listed here as "in active development" and "planned" are delivered: the unified People relationship timeline, Notes backlinks and knowledge links, Quick Capture wired to real record creation, the shared record lifecycle, Asset history and renewals, full workspace export and portability, backup and restore, cross-module search and saved views, the PWA and offline capture, Analytics, and the AI layer — which **proposes** changes for you to review, edit, accept or reject, and never writes to your data on its own.

**In active development.** Targeted hardening and feature work against the shared design system rather than another whole-app redesign: reliability of the release gate, accessibility follow-ups, and the daily-driver polish tracked in [`ROADMAP_V2_2.md`](docs/roadmap/ROADMAP_V2_2.md).

**Planned.** Deterministic natural-language capture v2, an offline Task mutation slice beyond capture, and optional imports and integrations.
